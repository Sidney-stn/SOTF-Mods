...
namespace Currency
{
    internal class Misc
    {
        ...
        {
            if (Config.DebugLoggingIngameCurrency.Value)
            {
                RLog.Msg(msg);
            }
        ...
        {
            dialogManager.QuitGameConfirmDialog.AddOnOption1ClickedCallback((Il2CppSystem.Action)Currency.OnLeaveWorld);  // Quit World Confirm Button Press
