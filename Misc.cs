...
namespace Banking
{
    internal class Misc
    {
        ...
        {
            if (Config.DebugLoggingIngameBanking.Value)
            {
                RLog.Msg(msg);
            }
        ...
        {
            dialogManager.QuitGameConfirmDialog.AddOnOption1ClickedCallback((Il2CppSystem.Action)Banking.OnLeaveWorld);  // Quit World Confirm Button Press
