...
namespace Signs.Prefab
{
    public class SignPrefab
    {
        ...
        public static GameObject spawnSignSingePlayer(Vector3 position, Quaternion rotation, bool isNew = true, string line1Text = null, string line2Text = null, string line3Text = null, string line4Text = null)
        {
            if (signWithComps != null)
            {
